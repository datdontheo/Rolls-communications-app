...
export const SEED_INVOICES: Invoice[] = [
  {
    ...
    dueDate: '2026-04-24',
    items: [
      { id: 'li-001', item: 'Branded Tote Bags', description: 'Custom screen-print, cotton', qty: 200, unitCost: 100.00 },
      { id: 'li-002', item: 'Branded Pens', description: 'UV logo print, ballpoint', qty: 500, unitCost: 15.00 },
      { id: 'li-003', item: 'Branded Notepads', description: 'A5, full-colour cover, 80pp', qty: 250, unitCost: 35.00 },
    ],
    subtotal: 36250.00,
    vatRate: 20,
    vat: 7250.00,
  ...
  },
  {
    ...
    dueDate: '2026-05-12',
    items: [
      { id: 'li-004', item: 'Outdoor Flex Banners', description: '6×10ft (set of 4)', qty: 4, unitCost: 1800.00 },
      { id: 'li-005', item: 'A4 Flyers', description: 'Full-colour (500 units, glossy)', qty: 500, unitCost: 4.50 },
      { id: 'li-006', item: 'In-Branch Posters', description: 'Design & Print (A2, set of 10)', qty: 10, unitCost: 220.00 },
    ],
    subtotal: 11650.00,
    vatRate: 20,
    vat: 2330.00,
  ...
  },
  {
    ...
    dueDate: '2026-03-29',
    items: [
      { id: 'li-007', item: 'Brochure Design & Print', description: 'Full-colour A4 tri-fold (1000 units)', qty: 1000, unitCost: 8.50 },
      { id: 'li-008', item: 'Event Backdrop', description: '8×6ft full bleed', qty: 2, unitCost: 1400.00 },
    ],
    subtotal: 11300.00,
    vatRate: 20,
    vat: 2260.00,
...
export const SEED_QUOTATIONS: Quotation[] = [
  {
    ...
    date: '2026-04-28',
    items: [
      { id: 'qi-001', item: '48-Sheet Billboard', description: 'Design & production (Airport Road)', qty: 2, unitCost: 8500.00 },
      { id: 'qi-002', item: 'Digital Campaign', description: '30-day social media package', qty: 1, unitCost: 5500.00 },
      { id: 'qi-003', item: 'Lightbox Ads', description: 'Airport scrolling (30-day placement)', qty: 4, unitCost: 1800.00 },
    ],
    subtotal: 29700.00,
    vatRate: 20,
    vat: 5940.00,
  ...
  },
  {
    ...
    date: '2026-04-15',
    items: [
      { id: 'qi-004', item: 'Business Cards', description: 'Design & print (400gsm, matt laminate, 500 units)', qty: 500, unitCost: 3.20 },
      { id: 'qi-005', item: 'Company Profile', description: 'Design (8-page A4, full colour)', qty: 1, unitCost: 1800.00 },
    ],
    subtotal: 3400.00,
    vatRate: 20,
    vat: 680.00,
  ...
  },
  {
    ...
    date: '2026-03-30',
    items: [
      { id: 'qi-006', item: 'Magazine Ad', description: 'Full-page (design + placement, 3 months)', qty: 3, unitCost: 4200.00 },
    ],
    subtotal: 12600.00,
    vatRate: 20,
    vat: 2520.00,
